...
{
    public class appPlaylistController : Controller
    {
        ...
        public ActionResult AddToPlayList()
        {
            ...
            if (User.Identity.IsAuthenticated == false)
                return Content("<script type='text/javascript'>window.location='/apps/appAccount/SignIn';</script>");
            //--------------------------------------------------------------------------------------------
        ...
        public ActionResult SubmitAddNewSong(string Song_Title, string Song_Guid, int? Sel_Playlist_ID, int? StayHereCheck, string ss)
        {
            ...
            else
            {
                ...
                return Content("/apps/appCreate/playlist?playlist_id=" + Sel_Playlist_ID, "text/html");
            }
            //-----------------------------------------------------------------------------------------
        ...
        public ActionResult CleanDeadLinksSubmit(int PlaylistID)
        {
            ...
            return RedirectPermanent("/apps/appCreate/playlist?playlist_id=" + PlaylistID);
        }
        //----------------------------------------------------------------------------------------------------------
