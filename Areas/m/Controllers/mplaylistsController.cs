...
{
    public class mplaylistsController : Controller
    {
        //
        // GET: /playlists/
        ...
        public ActionResult artist(string id)
        {
            ...
            string feedUrl1 = String.Format("http://gdata.youtube.com/feeds/api/videos?q={0}&category=Music&start-index={1}" + orderBy, HttpUtility.UrlEncode(id.Replace("+", " ")), (this_page1 * 25) - 25 + 1);
