...
namespace hypster.Areas.senses.Controllers
{
    ...
    public class sAccountController : Controller
    {
        ...
        public ActionResult Login()
        {
            ...
            {
                return RedirectPermanent("/senses/sStart/home");
            }*/
        ...
        public string LoginUser()
        {
            ...
            if (membersManager.ValidateUser(username, password))
            {
                ...
                return "<script type='text/javascript'>window.location='/senses/sStart';</script>";
            }
        ...
        public string logOut()
        {
            ...
            return "<script>window.location='/senses/sAccount/Login';</script>";
        }
        ...
        public PartialViewResult AddToMyPlaylistM(string id)
        {
            string song_guid = id;
        ...
        //------------------------------------------------------------------------------------------------------------------
        [AllowAnonymous]
        public string SetSpeechMic(string id)
        {
            HttpContext.Response.Cookies.Remove("speech_mic");


            HttpCookie myCookie = new HttpCookie("speech_mic");
            myCookie.Value = id;
