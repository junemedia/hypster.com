...
function ShuffleSongsI(us_id) {
    ...
    if (object != null) {
        $.ajax({
            type: "POST",
            url: "/apps/appPlaylist/getPlaylistDetailsPlayer?PL_ID=" + object[object.selectedIndex].value + "&US_ID=" + us_id + "&Sort=Rand",
            async: true,
            success: function (data) {
        ...
        $.ajax({
            type: "POST",
            url: "/apps/appPlaylist/getPlaylistDetailsPlayer?PL_ID=" + curr_playlist_id + "&US_ID=" + us_id + "&Sort=Rand",
            async: true,
            success: function (data) {
                $('#PlayerPlaylistHolder1').html(data);
            }
...
function LoadMoreSongsPlaylist() {
    ...
    $.ajax({
        type: "POST",
        url: "/apps/appPlaylist/getPlaylistSegmentPlayer?PL_ID=" + curr_playlist_id + "&US_ID=" + curr_user_id + "&Seg=" + curr_playlist_segment,
        async: true,
        success: function (data) {
