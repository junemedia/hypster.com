...
namespace hypster.Controllers
{
    public class ControllerBase : Controller
    {
        ...
        {
            // this code is tracking users from email / from ads
            //
            // comment when not need or some another tracking implemented
            if (Request.QueryString["ETT"] != null)
            {
                string emailTrackCode = Request.QueryString["ETT"].ToString();
