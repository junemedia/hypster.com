        ...
        public ActionResult getPlayer(string id)
        {
            ...
            switch (id)
            {
                ...
                case "ClassicPlayer":
                    ...
                    // vvs_tracker
                    //----------------------------------------------------------------------------------------------------------
                    hypster_tv_DAL.TrackLoginManagement trackLogin1 = new hypster_tv_DAL.TrackLoginManagement();

                    hypster_tv_DAL.TrackWebsite recTrack1 = new hypster_tv_DAL.TrackWebsite();
                    recTrack1.TrackWebsite_Key = "getPlayer_ClassicPlayer";
                    recTrack1.TrackWebsite_KeyID = 230011;
                    recTrack1.TrackWebsite_Val = User.Identity.Name;
                    recTrack1.TrackDate = DateTime.Now;

                    trackLogin1.hyDB.TrackWebsites.AddObject(recTrack1);
                ...
                case "RadioPlayer":
                    ...
                    hypster_tv_DAL.TrackWebsite recTrack2 = new hypster_tv_DAL.TrackWebsite();
                    recTrack2.TrackWebsite_Key = "getPlayer_BarPlayer";
                    recTrack2.TrackWebsite_KeyID = 230011;
                    recTrack2.TrackWebsite_Val = User.Identity.Name;
                    recTrack2.TrackDate = DateTime.Now;
