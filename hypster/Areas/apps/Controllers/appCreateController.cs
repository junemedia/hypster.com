...
{
    [Authorize]
    public class appCreateController : Controller
    {
        ...
        public ActionResult player(string id)
        {
            ...
            {
                return RedirectPermanent("/apps/appAccount/SignIn");
                ...
                switch (Request.QueryString["ACT"].ToString())
                {
                    ...
                    case "delete_song":
                        ...
                        if (d_song_id != 0)
                        {
                            ...
                            return RedirectPermanent("/apps/appCreate/playlist?playlist_id=" + pl_id);
                        }
                        break;
                    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
