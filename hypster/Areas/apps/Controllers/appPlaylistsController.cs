...
{
    public class appPlaylistsController : Controller
    {
        //
        // GET: /playlists/
        ...
        public ActionResult song(string id)
        {
            ...
            {
                SongTitle = Request.QueryString.ToString(); //id;
        ...
        public ActionResult station(string id)
        {
            ...
            {
                if (Genre_str == item.GenreName.ToLower())
                {
