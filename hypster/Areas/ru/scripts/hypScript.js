...
function ShowAddToMyPlaylist(song_id_url) {
    ...
    $.ajax({
        type: "POST",
        url: "/ru/Плейлисты/AddToPlayList" + song_id_url,
        async: true,
        success: function (data) {
            $('#popupContainer').html(data);
        }
...
function ShowAddToMyPlaylistPopup(song_id_url) {
    ...
    $.ajax({
        type: "POST",
        url: "/ru/Плейлисты/AddToPlayListPopup" + song_id_url,
        async: true,
        success: function (data) {
...
function StartMusicSearch() {
    ...
    if (ss_str != " Enter Artist, Song or Genre") {
        ...
        ss_str = ss_str.replace("?", "+");
        ss_str = ss_str.replace("!", "+");
        window.location = "/ru/Слушать?ss=" + ss_str;
    }
}
...
function SearchMusicStr(search_string) {
    ...
    var search_url = "/ru/Поиск/Music?ss=" + ss;
    if (isOrderOn != "") {
...
function SearchMusicStrPage(search_string, page) {
    ...
    var search_url = "/ru/Поиск/Music?ss=" + ss + "&page=" + page;
    if (isOrderOn != "") {
        search_url += "&orderBy=" + isOrderOn;
    }
...
function playlist_changed(object) {
    ...
    $.ajax({
        type: "POST",
        url: "/ru/Плейлисты/getPlaylistDetailsEdt?PL_ID=" + object[object.selectedIndex].value + "&PL_TYPE=BarPlayer",
        async: true,
        success: function (data) {
