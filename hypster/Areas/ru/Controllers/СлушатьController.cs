...
{
    public class СлушатьController : Controller
    {
        ...
        [OutputCache(Duration = 100, VaryByParam = "none")]
        public ActionResult Список_Радиостанций()
        {
            hypster.ViewModels.listenViewModel model = new ViewModels.listenViewModel();
        ...
        public ActionResult Самые_популярные_Плейлисты()
        {
            hypster.ViewModels.listenViewModel model = new ViewModels.listenViewModel();
