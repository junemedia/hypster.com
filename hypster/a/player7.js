...
function GeneratePlayerControls() {
    ...
    if (hypPlayerControls == 0) {
        player_height = PL_H + 4;
    } else {
        player_height = PL_H + 25;
    }
    //-------------------------------------------------------------------------------
    ...
    $(tag_player_cont).css("width", (PL_W+4) + "px");
    ...
    $("#hypPlayerCont").append("<div id='" + PlayerIDVar + "' style='float:left; width:" + PL_W + "px; height:" + PL_H + "px; margin:2px 0 0 2px; background-color:" + hypMainBackColor + ";' ></div>");
    //-------------------------------------------------------------------------------
...
function GenerateControlsBar() {
    ...
    $("#hypPlayerCont").append("<div id='hypPlayerMenu' style='float:left; width:" + PL_W + "px; height:21px; margin:0 0 0 2px; background:" + hypMainBackColor + " url(http://" + hypHostName + "/a/" + imgs_f + "/player_back.png) repeat-x;' />");
    ...
    $("#hypPlayerMenu").append("<a class=\"hypPlayer_Prev_btn\" href=\"javascript:PlayPrevVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/prev_icn.png') no-repeat center;\" ></a>");
    $("#hypPlayerMenu").append("<a class=\"hypPlayer_PlPs_btn\" href=\"javascript:PlayPauseVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/play_icn.png') no-repeat center;\" ></a>");
    $("#hypPlayerMenu").append("<a class=\"hypPlayer_Next_btn\" href=\"javascript:PlayNextVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/next_icn.png') no-repeat center;\" ></a>");
    $("#hypPlayerMenu").append("<a class=\"hypPlayer_Hypster_btn\" href=\"http://hypster.com/?rtg=p13\" title=\"Create Free Playlist Online\" target=\"_blank\" style=\" display:block; " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/hypster_icn.png') no-repeat center;\" ></a>");
...
function GenerateControlsBar_Additional() {
    ...
    var playback_control_bar = "<div style='float:left; width:108px; height:21px; margin:2px 0 0 2px; background:" + hypMainBackColor + " url(http://" + hypHostName + "/a/" + imgs_f + "/player_back.png) repeat-x; border-radius:2px;'>";

    var btn_style = "float:left; width:24px; height:19px; line-height:19px; margin:1px 0 0 2px; border-radius:3px; text-align:center; font-size:16px; color:#FFFFFF; cursor:pointer; font-weight:bold;";
    playback_control_bar += "<a class=\"hypPlayer_Prev_btn\" href=\"javascript:PlayPrevVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/prev_icn.png') no-repeat center;\" ></a>";
    playback_control_bar += "<a class=\"hypPlayer_PlPs_btn\" href=\"javascript:PlayPauseVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/play_icn.png') no-repeat center;\" ></a>";
    playback_control_bar += "<a class=\"hypPlayer_Next_btn\" href=\"javascript:PlayNextVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/next_icn.png') no-repeat center;\" ></a>";
    playback_control_bar += "<a class=\"hypPlayer_Hypster_btn\" href=\"http://hypster.com/?rtg=p13\" title=\"Create Free Playlist Online\" target=\"_blank\" style=\" display:block; " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/hypster_icn.png') no-repeat center;\" ></a>";
...
ga('stageTracker.set', 'dimension5', 'Dual');
