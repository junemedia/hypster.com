...
namespace hypster.Handlers
{
    ...
    public class RadioPlaylist : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string feedUrl = "http://gdata.youtube.com/feeds/api/videos?q=" + genre + "&category=Music&format=5&start-index=" + this_page + "&orderby=viewCount";
            ...
            string feedUrl_2 = "http://gdata.youtube.com/feeds/api/videos?q=" + genre + "&category=Music&format=5&start-index=" + (this_page * 25) + "&orderby=viewCount";
            ...
            string feedUrl_3 = "http://gdata.youtube.com/feeds/api/videos?q=" + genre + "&category=Music&format=5&start-index=" + (this_page * 25) + "&orderby=viewCount";
